"""
utils.py — Utilidades de soporte (Experimento 1)

  - Fijar semillas de aleatoriedad
  - Guardar / cargar métricas en JSON
  - Imprimir tabla resumen final
  - Detectar device (GPU / CPU)
"""
...
def print_summary_table(all_metrics: dict):
    """
    Imprime la tabla resumen de Macro F1 y Accuracy para los 5 datasets.

    all_metrics : {dataset_key: metrics_dict}
    """
